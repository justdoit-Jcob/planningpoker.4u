            ...
            return (
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center font-bold text-white text-sm shrink-0 shadow"
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      {isSelf && (
                        <span className="text-xs bg-indigo-900 text-indigo-300 px-1.5 py-0.2 rounded">
                          Ty
                        </span>
                      )}
                    </div>
                ...
                <div className="shrink-0">
                  {canCastVote(p) ? (
                    p.hasVoted ? (
                      ...
                      <span className="inline-flex items-center gap-1 text-xs font-medium text-slate-400 bg-slate-800/60 px-2 py-0.5 rounded-lg">
                        <Clock className="size-4 text-slate-500" />
                        <span>Wybiera...</span>
                      </span>
                    )
                  ) : (
                    <span className="text-xs text-slate-500 italic">Obserwuje</span>
                  )}
                </div>
              </div>
            );
