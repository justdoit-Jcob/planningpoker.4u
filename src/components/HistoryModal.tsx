...
import { History, Trash2, Calendar, CheckCircle, BarChart2, X } from 'lucide-react';
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-mono text-xs font-bold bg-indigo-950 text-indigo-300 border border-indigo-800/80 px-2 py-0.5 rounded">
                      Runda #{item.round}
                    </span>
                ...
                <div className="shrink-0 text-right pl-2 border-l border-slate-800">
                  <div className="text-xs text-slate-400 uppercase font-medium">Wynik</div>
